    ...
    return (
        <div className="flex flex-col justify-center items-center w-full md:w-[80%]">
            <div className="
                ...
                rounded-full w-[35%] xl:w-[22.5%] h-fit aspect-1/1
            ">
            ...
            <div className="flex flex-col w-full lg:w-[75%] gap-5">
                <Card className="flex justify-center items-center border-0 shadow-none bg-transparent">
                    <CardHeader className="flex flex-col items-center w-full gap- md:gap-3">
                        ...
                        <CardDescription className="text-lg md:text-2xl font-medium text-foreground">Junior Web Developer</CardDescription>
                    ...
                    <CardContent className="flex justify-center text-foreground text-center text-sm md:text-lg font-medium w-[320] md:w-[730]">
                        {textContent}
                    </CardContent>
